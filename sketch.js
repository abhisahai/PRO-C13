...
function draw() {
 background(0);
  ...
  // switch (destroy){
  //   case arrow.isTouching(redBalloon): redBalloon.destroy;
  //   break;
  //   case arrow.isTouching(blueBalloon): blueBalloon.destroy;
  //   break;
  //   case arrow.isTouching(pinkBalloon): pinkBalloon.destroy;
  //   break;
  //   case arrow.isTouching(greenBalloon): greenBalloon.destroy;
  //   break;
  // }
